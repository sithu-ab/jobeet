...
class AffiliateControllerTest extends WebTestCase
{
    private $em;
    private $application;
    private $fieldPrefix = 'ibw_jobeetbundle_';
    ...
    public function testAffiliateForm()
    {
        ...
        $form = $crawler->selectButton('Submit')->form(array(
            $this->fieldPrefix.'affiliate[url]' => 'http://sensio-labs.com/',
            $this->fieldPrefix.'affiliate[email]' => 'jobeet@example.com'
        ));
        ...
        $crawler = $client->request('GET', '/affiliate/new');
        $form = $crawler->selectButton('Submit')->form(array(
            $this->fieldPrefix.'affiliate[email]'        => 'not.an.email',
        ));
    ...
    public function testCreate()
    {
        ...
        $form = $crawler->selectButton('Submit')->form(array(
            $this->fieldPrefix.'affiliate[url]' => 'http://sensio-labs.com/',
            $this->fieldPrefix.'affiliate[email]' => 'address@example.com'
        ));
