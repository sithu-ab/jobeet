...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_expired->setType('part-time');
        $job_expired->setCompany('Like Myanmar');
        $job_expired->setUrl('http://lightmyanmar.com');
        $job_expired->setPosition('PHP Developer');
        $job_expired->setLocation('Yangon, Myanmar');
        $job_expired->setDescription('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.');
        $job_expired->setHowToApply('Send your resume to contact [at] likemyanmar.com');
        $job_expired->setIsPublic(true);
        $job_expired->setIsActivated(true);
        $job_expired->setToken('job_like_myanmar');
