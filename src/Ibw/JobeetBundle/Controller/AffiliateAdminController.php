...
class AffiliateAdminController extends Controller
{
    public function batchActionActivate(ProxyQueryInterface $selectedModelQuery)
    {
        ...
        try {
            foreach ($selectedModels as $selectedModel) {
                ...
                $message = \Swift_Message::newInstance()
                    ...
                    ->setBody($this->renderView('IbwJobeetBundle:Affiliate:email.txt.twig', array('affiliate' => $selectedModel->getToken())))
                ;
        ...
        $session->add('sonata_flash_success', sprintf('The selected accounts have been activated'));
    ...
    public function activateAction($id)
    {
        ...
        try {
            ...
            $message = \Swift_Message::newInstance()
              ...
              ->setBody($this->renderView('IbwJobeetBundle:Affiliate:email.txt.twig', array('affiliate' => $affiliate->getToken())))
            ;
